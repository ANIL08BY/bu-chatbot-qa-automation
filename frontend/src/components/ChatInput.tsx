  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
        <div
          className={`flex items-end gap-2 sm:gap-3 rounded-2xl px-3 sm:px-4 py-2 border transition-colors ${
            isDarkMode
        ...
        >
          <textarea
            ...
            placeholder={
              disabled ? "Yanıt bekleniyor..." : "Bana bir şey sor..."
            }
          ...
          >
            <Send
              size={17}
              className="text-white translate-y-px -translate-x-px"
              aria-hidden="true"
            />
          </button>
        </div>
      ...
      <div className="mt-2 flex items-center justify-center gap-2 px-1 min-h-[2rem]">
        <p
          className={`text-xs leading-snug text-center ${isDarkMode ? "text-gray-500" : "text-gray-400"}`}
        >
          Belek AI bir yapay zeka asistanıdır ve hata yapabilir. Önemli
          bilgileri web sitemizden kontrol edebilirsiniz.
        </p>
        <a
