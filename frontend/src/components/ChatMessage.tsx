          ...
          >
            {isUser ? (
              ...
              <p className="leading-relaxed text-sm sm:text-base">
                {displayedText}
                {!typingDone && (
                  <span className={`inline-block w-[2px] h-[1em] ml-[1px] align-middle animate-pulse ${
          ...
          {canFeedback && (
            <div className="mt-1 flex items-center pl-1 gap-2">
              ...
              <p
                ...
                aria-live="polite"
              >
                Teşekkürler. Geri bildiriminiz, Belek AI&apos;ı daha iyi hale getirmemize yardımcı olacak.
              </p>
            </div>
          )}
